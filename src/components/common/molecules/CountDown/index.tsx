/* TODO IF YOU OPENED THIS ONE
    YOU SHOULD APPLY A LOT OF CHANGES CUZ
    IT'S A BAD CLASS BASED COMPONENT WITHOUT TYPES
 */
...
import { Text as TextComponent } from '@components/main'
...
const TimerText = styled(TextComponent)<Size>`
  color: #fff;
  font-weight: 500;
  font-size: ${({ size }: Size) => size * 1.2}px;
`
...
class CountDown extends React.Component {
  ...
  renderCountDown = () => {
    ...
    if (hours > 0 && this.props.short) {
      return (
        <Component style={styles.timeCont} onPress={this.props.onPress}>
          <TimerText size={this.props.size}>{hours + days * 24}h</TimerText>
        </Component>
      )
    }
